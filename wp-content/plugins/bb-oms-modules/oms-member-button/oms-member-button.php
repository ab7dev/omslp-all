 ...
 */
class OMSMemberButtonClass extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(array(
			'name'            => __( 'Member Button', 'fl-builder' ),
			'description'     => __( 'A WERDE MITGLIED call to action button with instrument specific URLs.', 'fl-builder' ),
            'group'           => __( 'OMS Modules', 'fl-builder' ),
            'category'        => __( 'OMS Modules', 'fl-builder' ),
            'dir'             => OMS_MODULES_DIR . 'oms-member-button/',
            'url'             => OMS_MODULES_URL . 'oms-member-button/',
            'icon'            => 'button.svg',
 ...
 */
FLBuilder::register_module('OMSMemberButtonClass', array(
	'general' => array(
