	...
	@media (max-width: <?php echo $global_settings->large_breakpoint; ?>px) {
		.fl-node-<?php echo $id; ?> .fl-separator {
			...
			<?php if ( ! empty( $settings->width_large ) ) { ?>
				...
				width: <?php echo $settings->width_large . $settings->width_large_unit; ?>;
			<?php } ?>
	...
	@media (max-width: <?php echo $global_settings->medium_breakpoint; ?>px) {
		.fl-node-<?php echo $id; ?> .fl-separator {
			...
			<?php if ( ! empty( $settings->width_medium ) ) { ?>
				...
				width: <?php echo $settings->width_medium . $settings->width_medium_unit; ?>;
			<?php } ?>
	...
	@media (max-width: <?php echo $global_settings->responsive_breakpoint; ?>px) {
		.fl-node-<?php echo $id; ?> .fl-separator {
			...
			<?php if ( ! empty( $settings->width_responsive ) ) { ?>
				...
				width: <?php echo $settings->width_responsive . $settings->width_responsive_unit; ?>;
			<?php } ?>
