...
final class DialogLocalization extends AbstractConfigManagerWithLanguage
{
    ...
    public function defaultConfig(): DialogLocalizationDto
    {
        ...
        $defaultConfig->iabTcfHeadlineStorageInformationGranular = $localization['iabTcfHeadlineStorageInformationGranular'];
        $defaultConfig->iabTcfHeadlineStorageInformationDomains = $localization['iabTcfHeadlineStorageInformationDomains'];
        ...
        $defaultConfig->iabTcfStorageInformationCookieRefreshNo = $localization['iabTcfStorageInformationCookieRefreshNo'];
        $defaultConfig->iabTcfStorageInformationCookieRefreshYes = $localization['iabTcfStorageInformationCookieRefreshYes'];
        ...
        $defaultConfig->iabTcfStorageInformationDescription = $localization['iabTcfStorageInformationDescription'];
        $defaultConfig->iabTcfStorageInformationDomain = $localization['iabTcfStorageInformationDomain'];
        $defaultConfig->iabTcfStorageInformationDomains = $localization['iabTcfStorageInformationDomains'];
        $defaultConfig->iabTcfStorageInformationDomainsTableDomainName = $localization['iabTcfStorageInformationDomainsTableDomainName'];
        $defaultConfig->iabTcfStorageInformationDomainsTableUse = $localization['iabTcfStorageInformationDomainsTableUse'];
        $defaultConfig->iabTcfStorageInformationIdentifier = $localization['iabTcfStorageInformationIdentifier'];
        $defaultConfig->iabTcfStorageInformationLoading = $localization['iabTcfStorageInformationLoading'];
        $defaultConfig->iabTcfStorageInformationMaxAgeSeconds = $localization['iabTcfStorageInformationMaxAgeSeconds'];
        $defaultConfig->iabTcfStorageInformationOptOut = $localization['iabTcfStorageInformationOptOut'];
        $defaultConfig->iabTcfStorageInformationOptOutNo = $localization['iabTcfStorageInformationOptOutNo'];
        $defaultConfig->iabTcfStorageInformationOptOutYes = $localization['iabTcfStorageInformationOptOutYes'];
        $defaultConfig->iabTcfStorageInformationPurposes = $localization['iabTcfStorageInformationPurposes'];
        $defaultConfig->iabTcfStorageInformationShowLess = $localization['iabTcfStorageInformationShowLess'];
        $defaultConfig->iabTcfStorageInformationShowMore = $localization['iabTcfStorageInformationShowMore'];
        $defaultConfig->iabTcfStorageInformationSpecialPurposes = $localization['iabTcfStorageInformationSpecialPurposes'];
        ...
        $defaultConfig->iabTcfStorageInformationTypeApp = $localization['iabTcfStorageInformationTypeApp'];
        $defaultConfig->iabTcfStorageInformationTypeCookie = $localization['iabTcfStorageInformationTypeCookie'];
        $defaultConfig->iabTcfStorageInformationTypeWeb = $localization['iabTcfStorageInformationTypeWeb'];
