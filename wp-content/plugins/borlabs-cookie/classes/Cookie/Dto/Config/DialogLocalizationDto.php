...
final class DialogLocalizationDto extends AbstractConfigDto
{
    ...
    public string $iabTcfHeadlineStorageInformationDomains = '';

    public string $iabTcfHeadlineStorageInformationGranular = '';
    ...
    public string $iabTcfStorageInformationCookieRefreshNo = '';

    public string $iabTcfStorageInformationCookieRefreshYes = '';
    ...
    public string $iabTcfStorageInformationDescription = '';

    public string $iabTcfStorageInformationDomain = '';

    public string $iabTcfStorageInformationDomains = '';

    public string $iabTcfStorageInformationDomainsTableDomainName = '';

    public string $iabTcfStorageInformationDomainsTableUse = '';

    public string $iabTcfStorageInformationIdentifier = '';

    public string $iabTcfStorageInformationLoading = '';

    public string $iabTcfStorageInformationMaxAgeSeconds = '';

    public string $iabTcfStorageInformationOptOut = '';

    public string $iabTcfStorageInformationOptOutNo = '';

    public string $iabTcfStorageInformationOptOutYes = '';

    public string $iabTcfStorageInformationPurposes = '';

    public string $iabTcfStorageInformationShowLess = '';

    public string $iabTcfStorageInformationShowMore = '';

    public string $iabTcfStorageInformationSpecialPurposes = '';
    ...
    public string $iabTcfStorageInformationTypeApp = '';

    public string $iabTcfStorageInformationTypeCookie = '';

    public string $iabTcfStorageInformationTypeWeb = '';
