...
use Borlabs\Cookie\Dependencies\Twig\Node\Expression\Filter\RawFilter;
use Borlabs\Cookie\Dependencies\Twig\Node\Node;
use Borlabs\Cookie\Dependencies\Twig\NodeVisitor\EscaperNodeVisitor;
use Borlabs\Cookie\Dependencies\Twig\Runtime\EscaperRuntime;
...
final class EscaperExtension extends AbstractExtension
{
    ...
    public function setEnvironment(Environment $environment, bool $triggerDeprecation = true): void
    {
        if ($triggerDeprecation) {
            trigger_deprecation('twig/twig', '3.10', 'The "%s()" method is deprecated and not needed if you are using methods from "Borlabs\Cookie\Dependencies\Twig\Runtime\EscaperRuntime".', __METHOD__);
        }
    ...
    {
        trigger_deprecation('twig/twig', '3.10', 'The "%s()" method is deprecated, use the "Borlabs\Cookie\Dependencies\Twig\Runtime\EscaperRuntime::setEscaper()" method instead (be warned that Environment is not passed anymore to the callable).', __METHOD__);
    ...
    {
        trigger_deprecation('twig/twig', '3.10', 'The "%s()" method is deprecated, use the "Borlabs\Cookie\Dependencies\Twig\Runtime\EscaperRuntime::getEscaper()" method instead.', __METHOD__);
    ...
    {
        trigger_deprecation('twig/twig', '3.10', 'The "%s()" method is deprecated, use the "Borlabs\Cookie\Dependencies\Twig\Runtime\EscaperRuntime::setSafeClasses()" method instead.', __METHOD__);
    ...
    {
        trigger_deprecation('twig/twig', '3.10', 'The "%s()" method is deprecated, use the "Borlabs\Cookie\Dependencies\Twig\Runtime\EscaperRuntime::addSafeClass()" method instead.', __METHOD__);
