...
final class OptimizerNodeVisitor implements NodeVisitorInterface
{
    ...
    public function __construct(int $optimizers = -1)
    {
        ...
        if (-1 !== $optimizers && self::OPTIMIZE_RAW_FILTER === (self::OPTIMIZE_RAW_FILTER & $optimizers)) {
            trigger_deprecation('twig/twig', '3.11', 'The "Borlabs\Cookie\Dependencies\Twig\NodeVisitor\OptimizerNodeVisitor::OPTIMIZE_RAW_FILTER" option is deprecated and does nothing.');
        }
