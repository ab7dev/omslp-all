...
use Borlabs\Cookie\Dependencies\Twig\Attribute\YieldReady;
...
class CaptureNode extends Node
{
    ...
    public function compile(Compiler $compiler): void
    {
        ...
        $compiler
            ->raw($useYield ? "implode('', iterator_to_array(" : '\\Borlabs\\Cookie\\Dependencies\\Twig\\Extension\\CoreExtension::captureOutput(')
