...
$template['daily_report']['subject'] = __('Daily Activity Report for %s', 'nfwplus');
...
This notification can be turned off from NinjaFirewall "Event Notifications" page.', 'nfwplus');
...
$template['disabled']['subject'] = __('Alert: Firewall is disabled', 'nfwplus');
...
$template['debugging']['subject'] = __('Alert: Firewall is disabled', 'nfwplus');
...
$template['fw_override']['subject'] = __('Alert: Firewall override settings', 'nfwplus');
...
$template['fc_detection']['subject'] = __('Alert: File Check detection', 'nfwplus');
...
See attached file for details.', 'nfwplus');
...
$template['fc_report']['subject'] = __('File Check report', 'nfwplus');
...
$template['rules_update']['subject'] = __('Security rules update', 'nfwplus');
...
This notification can be turned off from NinjaFirewall "Security Rules" page.', 'nfwplus');
...
$template['perm_edit']['subject'] = __('Blocked post/page edition attempt', 'nfwplus');
...
%10$s
This protection (and notification) can be turned off from NinjaFirewall "Firewall Policies" page.', 'nfwplus');
...
$template['perm_delete']['subject'] = __('Blocked post/page deletion attempt', 'nfwplus');
...
$template['create_user']['subject'] = __('Blocked user account creation', 'nfwplus');
...
$template['delete_user']['subject'] = __('Blocked user deletion attempt', 'nfwplus');
...
$template['user_login']['subject'] = __('Alert: WordPress console login', 'nfwplus');
...
$template['database_change']['subject'] = __('Alert: Database changes detected', 'nfwplus');
...
$template['privilege_escalation']['subject'] = __('Blocked privilege escalation attempt', 'nfwplus');
...
$template['wp_settings']['subject'] = __('Attempt to modify WordPress settings', 'nfwplus');
...
$template['security_updates']['subject'] = __('Warning: Security update available', 'nfwplus');
...
$template['events']['subject'] = __('Alert: %s', 'nfwplus');
