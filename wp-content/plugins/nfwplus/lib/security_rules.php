...
?>
<div class="wrap">
	<h1><img style="vertical-align:top;width:33px;height:33px;" src="<?php echo plugins_url( '/nfwplus/images/ninjafirewall_32.png' ) ?>">&nbsp;<?php _e('Security Rules', 'nfwplus') ?></h1>
	<br />
	<h2 class="nav-tab-wrapper wp-clearfix" style="cursor:pointer">
		<a id="tab-updates" class="nav-tab<?php echo $updates_tab ?>" onClick="nfwjs_switch_tabs('updates', 'updates:editor')"><?php _e( 'Rules Updates', 'nfwplus' ) ?></a>
		<a id="tab-editor" class="nav-tab<?php echo $editor_tab ?>" onClick="nfwjs_switch_tabs('editor', 'updates:editor')"><?php _e( 'Rules Editor', 'nfwplus' ) ?></a>
