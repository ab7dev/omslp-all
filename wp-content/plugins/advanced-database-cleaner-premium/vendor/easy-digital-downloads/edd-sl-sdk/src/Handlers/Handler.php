...
abstract class Handler {
	...
	public function ajax_get_license_overlay() {
		...
		check_ajax_referer( 'edd_sdk_notice', 'nonce' );

		$template_raw = filter_input( INPUT_GET, 'template', FILTER_SANITIZE_SPECIAL_CHARS );

		$allowed_templates = array( 'license-control' );
		if ( ! in_array( $template_raw, $allowed_templates, true ) ) {
		...
		<?php
		\EasyDigitalDownloads\Updater\Templates::load( $template_raw, $args );
