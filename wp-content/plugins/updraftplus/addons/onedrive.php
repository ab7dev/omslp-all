	...
	public function get_pre_configuration_template() {
		...
		<tr class="{{get_template_css_classes false}} onedrive_pre_config_container">
			<td colspan="2">
				...
				<p>
					<a href="https://teamupdraft.com/documentation/updraftplus/topics/cloud-storage/microsoft-onedrive/faqs/how-to-setup-a-onedrive-developer-application/" target="_blank">
